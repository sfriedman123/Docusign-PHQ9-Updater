...
public class DemographicsScores {


	public int computeScore(String jsonData) {
		...
		for (int i = 0; i < radioGroupTabs.length(); i++) {
			...
			if ("PHQ9Difficulty".equals(radioGroup.optString("groupName")  ) || "GAD7Difficulty".equals(radioGroup.optString("groupName") )) {
